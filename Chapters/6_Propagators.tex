...
\begin{tikzpicture}
  \begin{feynman}
    \vertex (v1);
    \vertex [left=0.1cm of v1] (a) {$(x,t)$};
    \vertex [above left=of v1] (i1) {$n$};
    \vertex [below left=of v1] (i2) {$p$};
    \vertex [right=of v1] (v2);
    \vertex [right=0.1cm of v2] (b) {$(y,t')$};
    \vertex [above right=of v2] (f1) {$p$};
    \vertex [below right=of v2] (f2) {$n$};
    \diagram* {
    (v1) -- [fermion, edge label'=$\pi^+$] (v2),
    (i1) -- [fermion] (v1),
    (i2) -- [fermion] (v1),
    (v2) -- [fermion] (f1),
    (v2) -- [fermion] (f2),
