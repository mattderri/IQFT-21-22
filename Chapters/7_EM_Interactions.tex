...
\begin{tikzpicture}
  \begin{feynman}
    ...
    \vertex [below=0.1cm of v1] (a) {$x_2$};
    \vertex [right=of v1] (v2);
    \vertex [below=0.1cm of v2] (b) {$x_1$};
    \vertex [right=of v2] (f1) {$e^-$};
    \vertex [above left=of v1] (i2) {$\gamma$};
    \vertex [above right=of v2] (f2) {$\gamma$};
    \vertex [below right=0.5cm and 0.5cm of v1] (a) {(a)};
    \diagram* {
    (v1) -- [fermion] (v2),
    (i1) -- [fermion] (v1),
    (i2) -- [photon] (v1),
...
\begin{tikzpicture}
  \begin{feynman}
    ...
    \vertex [above left=of v1] (i2) {$\gamma$};
    \vertex [above right=of v2] (f2) {$\gamma$};
    \vertex [below right=0.5cm and 0.5cm of v1] (a) {(b)};
    \diagram* {
    (v1) -- [fermion] (v2),
    (i1) -- [fermion] (v1),
    (i2) -- [photon] (v2),
...
\begin{tikzpicture}
  \begin{feynman}
    \vertex (v1);
    \vertex [right=of v1] (v2);
    \vertex [above left=of v1] (i1) {$e^-$};
    \vertex [below left=of v1] (i2) {$e^+$};
    \vertex [above right=of v2] (f1) {$e^-$};
    \vertex [below right=of v2] (f2) {$e^+$};
    \vertex [left=0.1cm of v1] (a) {$x_2$};
    \vertex [right=0.1cm of v2] (b) {$x_1$};
    \vertex [below right=0.5cm and 0.5cm of v1] (a) {(a)};
    \diagram* {
    (v1) -- [photon] (v2),
    (i1) -- [fermion] (v1),
...
%     \labfig{positron}
% \end{marginfigure}
What happens when we have \textbf{anti-particles}, e.g. a positron?\marginnote{\begin{center}
\begin{tikzpicture}
  \begin{feynman}
    \vertex (i1) {$e^+$};
    \vertex [right=of i1] (v);
    \vertex [right=of v] (f1) {$e^+$};
    \vertex [above right=of v] (f2) {$\gamma$};
    \diagram* {
    (i1) -- [anti fermion, momentum'=$p$] (v),
    (v) -- [anti fermion, momentum'=$p'$] (f1),
    (v) -- [photon, momentum=$k'$] (f2),
    };
    \end{feynman}
\end{tikzpicture}
\end{center}}
...
The last thing left to compute is the \textbf{electron self-energy}:\marginnote{\begin{center}
\begin{tikzpicture}
  \begin{feynman}
    \vertex (i);
    ...
    \diagram* {
    (i) -- [fermion, momentum'=$p$] (v1),
    (v1) -- [fermion, momentum'=$q_1$] (v2),
    (v2) -- [fermion, momentum'=$p'$] (f),
    (v1) -- [photon, half left, momentum=$q_2$] (v2),
    };
    \end{feynman}
\end{tikzpicture}
\end{center}}
...
\begin{tikzpicture}
  \begin{feynman}
    ...
    \vertex [above left=of v1] (i1) {$e^-$};
    \vertex [below left=of v1] (i2) {$e^+$};
    \vertex [above right=of v2] (f1) {$\mu^-$};
    \vertex [below right=of v2] (f2) {$\mu^+$};
    \vertex [left=0.1cm of v1] (a) {$x_1$};
    \vertex [right=0.1cm of v2] (b) {$x_2$};
    \diagram* {
    (v1) -- [photon] (v2),
    (i1) -- [fermion] (v1),
    (i2) -- [anti fermion] (v1),
...
\begin{tikzpicture}
  \begin{feynman}
    \vertex (v1);
    \vertex [right=of v1] (v2);
    \vertex [above=of v1] (i1) {$e^-$};
    \vertex [below=of v1] (i2) {$e^+$};
    \vertex [above=of v2] (f1) {$\mu^-$};
    \vertex [below=of v2] (f2) {$\mu^+$};
    \vertex [left=0.1cm of v1] (a) {$x_1$};
    \vertex [right=0.1cm of v2] (b) {$x_2$};
    \diagram* {
    (v1) -- [photon] (v2),
...
\]
As we said we focus just on the diagram on the left and, using the Feynman rules we found in \refsec{frules}, we can write the transition amplitude as:\marginnote{\begin{center}
\begin{tikzpicture}
  \begin{feynman}
    \vertex (v1);
    \vertex [right=of v1] (v2);
    ...
    \vertex [above right=of v2] (f1) {$\mu^-$};
    \vertex [below right=of v2] (f2) {$\mu^+$};
    \vertex [left=0.1cm of v1] (a) {$\mu$};
    \vertex [right=0.1cm of v2] (b) {$\nu$};
    \diagram* {
    (v1) -- [photon, momentum'=$p_1+p_2$] (v2),
    (i1) -- [fermion, momentum=$p_1$] (v1),
    (i2) -- [anti fermion, momentum'=$p_2$] (v1),
    (v2) -- [fermion, momentum=$p_3$] (f1),
    (v2) -- [anti fermion, momentum'=$p_4$] (f2),
    };
    \end{feynman}
\end{tikzpicture}
\end{center}}
...
\]
And finally we obtain:\marginnote{This depends on the energy of the incoming particle. For instance, a beam of 100 GeV will give us a cross section of $\sigma\sim10^{-12}$ barn.}
\[
